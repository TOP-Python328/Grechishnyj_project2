...
cube = Kind(
    ...
    MaturePhase(
        5, 
        KindParameter(Parameters(Health).name, 100, 0, 100),
        KindParameter(Parameters(Satiety).name, 100, 0, 100),
        KindParameter(Parameters(Fatigue).name, 100, 0, 100),
        KindParameter(Parameters(Hygiene).name, 100, 0, 100),
        KindParameter(Parameters(Mood).name, 100, 0, 100),
        KindParameter(Parameters(Stamina).name, 100, 0, 100)
    ),
    MaturePhase(
        20, 
        KindParameter(Parameters(Health).name, 100, 0, 100),
